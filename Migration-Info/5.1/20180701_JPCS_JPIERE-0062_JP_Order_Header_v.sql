DROP VIEW adempiere.JP_Order_Header_v;
CREATE OR REPLACE VIEW adempiere.JP_Order_Header_v AS 
SELECT 
o.C_Order_ID
 ,o.AD_Client_ID
 ...
 ,o.TotalLines
 ,o.GrandTotal
 ,(SELECT sum(TaxAmt) From adempiere.C_OrderTax ot WHERE ot.C_Order_ID = o.C_Order_ID )AS TaxAmt
 ,(SELECT sum(TaxBaseAmt) From adempiere.C_OrderTax ot WHERE ot.C_Order_ID = o.C_Order_ID )AS TaxBaseAmt
 ...
 FROM adempiere.C_Order o
	...
	INNER JOIN adempiere.C_BPartner_Location bpl on(o.C_BPartner_Location_ID = bpl.C_BPartner_Location_ID)
